...
public class Staff_EuclideanTransposer extends ItemTool
{
    public Staff_EuclideanTransposer(ToolMaterial material, String name)
    {
    ...
    public boolean onItemUse(ItemStack thestaff, EntityPlayer player, World world, int i1, int j1, int k1, int theface, float p_77648_8_, float p_77648_9_, float p_77648_10_)
    {
    	...
    	if (!player.isSneaking()){
    		...
    		if(world.getBlock(i1, j1, k1) == ModRegistry.TranscriberBlock){
