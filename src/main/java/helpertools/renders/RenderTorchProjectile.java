...
public class RenderTorchProjectile extends Render
{
     ...
     */
    public void doRenderEntityTorchProjectile(Torch_Projectile entity, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(Torch_Projectile p_110775_1_)
    {
    ...
    {
        return this.getEntityTexture((Torch_Projectile)p_110775_1_);
    }
    ...
    {
        this.doRenderEntityTorchProjectile((Torch_Projectile)entity, p_76986_2_, p_76986_4_, p_76986_6_, p_76986_8_, p_76986_9_);
    }
}