...
public class Torch_Projectile extends EntityThrowable{

	//required fields to extend Entitythrowable
   public Torch_Projectile(World par1World) {
       super(par1World);
   }

   public Torch_Projectile(World par2World, EntityPlayer par3EntityPlayer) {
       super(par2World,par3EntityPlayer);
   }
   
 //spawns with a designated projectory for dispencers
   public Torch_Projectile(World world, double d, double e, double f, 
