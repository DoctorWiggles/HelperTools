...
public class Staff_Transformation extends ToolBase_Default
{
    public Staff_Transformation(ToolMaterial material, String unlocalizedName)
    {
    	super (material);  
	...
	public void TRANSFORM (ItemStack stack, EntityPlayer player, World world, BlockPos pos)
	{
        ...
        if(Config.ExchangeReturns)world.getBlockState(pos).getBlock().dropBlockAsItem(world, pos, world.getBlockState(pos), 0);
