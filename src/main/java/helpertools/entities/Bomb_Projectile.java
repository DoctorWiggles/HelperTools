...
public class Bomb_Projectile extends EntityThrowable{
	
   public int Bomb_Type;
   public int Amplify;

   //all else spawn
   public Bomb_Projectile(World world) {
       super(world);
       this.Bomb_Type = 0;
       Typesync(0);
       this.Amplify = 0;
   ...
   //spawn from a player
   public Bomb_Projectile(World world, EntityPlayer player, int type) {
       super(world,player);       
       this.Bomb_Type = type;  
       this.Amplify = 0;
   }
 ...
 //spawn from a player with amplification
   public Bomb_Projectile(World world, EntityPlayer player, int type, int amp) {
       super(world,player);       
       this.Bomb_Type = type;
       Typesync(type);
       this.Amplify = amp;
   ...
   public Bomb_Projectile(World world, double d, double e, double f, int type) {
       super(world);       
   ...
   //spawns with a designated projectory
   public Bomb_Projectile(World world, double d, double e, double f, int type, int amp,
		   double x, double y, double z, float f1, float f2) {
       super(world);       
       this.setPosition(d, e, f);
       this.Bomb_Type = type;  
   ...
   Block pblock = ModRegistry.LooseDirtBlock;
   
   //type transformer
   public Block p_block(int type){
	Block block = Blocks.dirt;
	
	if(type == 0){block = ModRegistry.LooseDirtBlock;}
