...
public class RenderBoltProjectile extends Render
{
    ...
    public void doRenderEntityBoltProjectile(EntityBoltProjectile entity, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_)
    {
       ...
       // tessellator.draw();
        ...
        Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation("helpertools", "textures/models/Bolttexpmap2.png"));  
        //Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation("helpertools", "textures/models/Test1.png"));
        //ModelBoltProjectile1.rendermodel(0.625F);
