...
public class RedTorch_Projectile extends EntityThrowable{

   public RedTorch_Projectile(World par1World) {
       super(par1World);
   }

   public RedTorch_Projectile(World par2World, EntityPlayer par3EntityPlayer) {
       super(par2World,par3EntityPlayer);
   }
   
 //spawns with a designated projectory for dispencers
   public RedTorch_Projectile(World world, double d, double e, double f, 
   ...
   //adds particle effcts if enabled
   /**
   ...
   **/
   //Makes this entity unique from others
   @Override
   ...
   //When this entity hits something, do something
   @Override
