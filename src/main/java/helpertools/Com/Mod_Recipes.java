		...
		static class Charm_recipe extends Mod_recipe{
			...
			public ItemStack upgrade(ItemStack stack){
				...
				if(level <5){
					...
					switch(level+1){
						case 2:future_output.setStackDisplayName("˜aPulsing Bomb Charm (+2)"); break;
						case 3:future_output.setStackDisplayName("˜eGreater Bomb Charm (+3)"); break;
						case 4:future_output.setStackDisplayName("˜9Grand Bomb Charm (+4)"); break;
						case 5:future_output.setStackDisplayName("˜dMaster Bomb Charm (+5)"); break;
					}
