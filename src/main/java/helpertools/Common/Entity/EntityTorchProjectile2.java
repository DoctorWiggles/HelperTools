...
public class EntityTorchProjectile2 extends EntityThrowable{

	//required fields to extend Entitythrowable
   public EntityTorchProjectile2(World par1World) {
       super(par1World);
   }

   public EntityTorchProjectile2(World par2World, EntityPlayer par3EntityPlayer) {
