...
public class Render_RedTorchProjectile extends Render
{
	...
	public Render_RedTorchProjectile(RenderManager render)
    {
        super(render);
    ...
    protected ResourceLocation getEntityTexture(Projectile_RedTorch p_110775_1_)
    {
    ...
    {
        return this.getEntityTexture((Projectile_RedTorch)p_110775_1_);
    }

    public void doRender(Entity entity, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_)
    {
        this.doRender((Projectile_RedTorch)entity, p_76986_2_, p_76986_4_, p_76986_6_, p_76986_8_, p_76986_9_);
    }
}