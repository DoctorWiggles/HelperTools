...
public class Transcriber_Block extends Block implements ITileEntityProvider
{
    ...
    public Transcriber_Block(String name)
    {
        super(Material.clay);
    ...
    {
		return Item.getItemFromBlock(ModRegistry.TranscriberBlock);
    }
