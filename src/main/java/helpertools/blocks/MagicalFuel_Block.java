...
public class MagicalFuel_Block extends Block
{
    ...
    public MagicalFuel_Block(String name)
    {
        super(Material.clay);
	    ...
	    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int p_149727_6_, float p_149727_7_, float p_149727_8_, float p_149727_9_)
	    {
	        ...
	        if (itemstack == null)
            {
	        	if(player.capabilities.isCreativeMode){
	        		...
	        		world.setBlock(x, y, z, ModRegistry.ActiveMagicalFuelBlock, 1, 123);}
	    ...
	    public void onBlockAdded(World world, int x, int y, int z)
	    {
	        if (!world.isRemote)
	        {
	            ...
	            {
	                world.setBlock(x, y, z, ModRegistry.ActiveMagicalFuelBlock);
	            }
	        }
	    }
