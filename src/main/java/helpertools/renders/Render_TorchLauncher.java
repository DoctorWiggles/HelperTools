...
import helpertools.models.Model_TorchLauncher;
...
public class Render_TorchLauncher implements IItemRenderer {

	private Model_TorchLauncher model;
		
	public Render_TorchLauncher()
	{
		
		model = new Model_TorchLauncher();
	}
