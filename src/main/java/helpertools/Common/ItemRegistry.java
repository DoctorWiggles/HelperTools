...
public class ItemRegistry {
	...
	public static void createItems() {
		...
		GameRegistry.registerItem(expandertool = new ItemStaffofExpansion(Config.ExpRod_Matt, "expander_item"), "expander_item");
		GameRegistry.registerItem(exchange_tool = new ItemStaffofTransformation(Config.Exchange_Matt, "exchange_item"), "exchange_item");
		GameRegistry.registerItem(pattern_tool = new ItemEuclideanTransposer(Config.Pattern_Matt, "pattern_item"), "pattern_item");
		GameRegistry.registerItem(crossbow_tool = new ItemTorchLauncher(Config.Crossbow_Matt, "crossbow_item"),"crossbow_item");		
