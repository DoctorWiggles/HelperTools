...
public class RenderRedTorchProjectile extends Render
{
	...
	public RenderRedTorchProjectile()
	{
     ...
     */
    public void doRenderEntityRedTorchProjectile(EntityRedTorchProjectile entity, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_)
    {
        ...
        //This above here dynamically rotates the model based on how it moves
        
        //tessellator is for creating the model within this thingy
        //
       ...
       // tessellator.draw();
        ...
        //ModelRedTorchProjectile1.rendermodel(0.625F);
     ...
     */
    protected ResourceLocation getEntityTexture(EntityRedTorchProjectile p_110775_1_)
    {
    ...
    {
        return this.getEntityTexture((EntityRedTorchProjectile)p_110775_1_);
    }
    ...
    {
        this.doRenderEntityRedTorchProjectile((EntityRedTorchProjectile)entity, p_76986_2_, p_76986_4_, p_76986_6_, p_76986_8_, p_76986_9_);
    }
}