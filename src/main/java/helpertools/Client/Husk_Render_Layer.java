...
public final class Husk_Render_Layer implements LayerRenderer<EntityLivingBase> {
		...
		@Override
		public void doRenderLayer(@Nonnull EntityLivingBase player, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
		...
		public static void SneakingOffset(EntityLivingBase player) {
