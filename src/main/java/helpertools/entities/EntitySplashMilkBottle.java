...
public class EntitySplashMilkBottle extends EntityThrowable{

   public EntitySplashMilkBottle(World par1World) {
       super(par1World);
   }

   public EntitySplashMilkBottle(World par2World, EntityPlayer par3EntityPlayer) {
