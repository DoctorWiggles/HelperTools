...
public class RecipeFactory extends Mod_Recipes{	
	...
	//Blocks		
		...
		ShapelessRecipe(Recipe_Balloon,new ItemStack(BalloonBlock, Output_Balloon, 0 ), new Object[]{
			"balloon_filling", "balloon_fuel", Items.STRING });
		
		ShapelessRecipe(Recipe_Floater,new ItemStack(FloaterBlock, 1, 0 ), new Object[]{
			BalloonBlock, BalloonBlock, "logWood" });		
		
		ShapelessRecipe(Recipe_Lamp,new ItemStack(LampBlock, Output_Lamp , 0), new Object[]{
			"ingotIron", new ItemStack(Items.DYE, 1, 15), "gemLapis"});
