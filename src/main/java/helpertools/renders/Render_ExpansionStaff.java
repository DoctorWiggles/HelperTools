...
import helpertools.models.Model_ExpansionStaff;
...
public class Render_ExpansionStaff implements IItemRenderer {

	private Model_ExpansionStaff model;
		
	public Render_ExpansionStaff()
	{
		
		model = new Model_ExpansionStaff();
	}
