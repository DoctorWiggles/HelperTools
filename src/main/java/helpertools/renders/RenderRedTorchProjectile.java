...
public class RenderRedTorchProjectile extends Render
{
     ...
     */
    public void doRenderEntityRedTorchProjectile(RedTorch_Projectile entity, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(RedTorch_Projectile p_110775_1_)
    {
    ...
    {
        return this.getEntityTexture((RedTorch_Projectile)p_110775_1_);
    }
    ...
    {
        this.doRenderEntityRedTorchProjectile((RedTorch_Projectile)entity, p_76986_2_, p_76986_4_, p_76986_6_, p_76986_8_, p_76986_9_);
    }
}